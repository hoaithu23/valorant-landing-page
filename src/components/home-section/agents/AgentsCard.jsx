...
const AgentsCard = props => {
    ...
    const onClick = () =>{
        ...
        newNode.id = `agents-img-${props.id}`
        ...
        document.querySelector(`#agents-detail-${props.id} iframe`).setAttribute('src', videoUrl)
        document.querySelector(`#agents-detail-${props.id}`).classList.add('active')
    }

    return (
        <div className="agents-card" onClick={onClick} ref={cardRef} >
            <div className="frame">
